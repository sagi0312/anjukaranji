...
blurb: "When an AI helps you integrate another AI — wiring MCP servers, Claude's API, and learning the 5-line rule."
date: "2024-05-01"
...
Getting it there involved the usual Supabase/Vercel dance—Auth redirects pointing at localhost, environment variables playing hide-and-seek, and ESLint blocking deployment over my types. Not glamorous, but it finally is deployed!
